...
export default function SobreNos({ darkMode, toggleTheme }) {
  ...
  return (
    ...
    >
      ...
      {/* Fórum - formulário com FormSubmit */}
      <div
        ref={setRef("forum")}
        data-section="forum"
        className={`p-6 sm:p-8 rounded-3xl shadow-xl max-w-3xl w-full text-center transition-all duration-1000 transform leading-relaxed text-sm sm:text-lg ${
      ...
      >
        ...
        >
          ...
          {/* (Opcional) desabilitar captcha: <input type=\"hidden\" name=\"_captcha\" value=\"false\" /> */}
          {/* (Opcional) redirecionar após envio: <input type=\"hidden\" name=\"_next\" value=\"https://seusite.com/obrigado\" /> */}
      ...
      {/* Ajuda - formulário com FormSubmit */}
      <div
        ref={setRef("ajuda")}
        data-section="ajuda"
        className={`p-6 sm:p-8 rounded-3xl shadow-xl max-w-3xl w-full text-center transition-all duration-1000 transform leading-relaxed text-sm sm:text-lg ${
