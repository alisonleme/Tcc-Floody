      ...
      <div className={`fixed top-0 left-0 w-full h-[120px] overflow-hidden z-50 ${darkMode ? "bg-gray-900" : ""}`}>
        ...
        <div className="absolute inset-0 h-full">
          <div className="absolute left-1/2 top-[30px] transform -translate-x-1/2 flex space-x-12">
            <Link to="/" className="text-white hover:text-blue-500 text-xl font-bold px-6 py-2 whitespace-nowrap cursor-pointer transition">
              Home
            </Link>
            <Link to="/jogo" className="text-white hover:text-blue-500 text-xl font-bold px-6 py-2 whitespace-nowrap cursor-pointer transition">
              Jogo
            </Link>
            <Link to="/materias" className="text-white hover:text-blue-500 text-xl font-bold px-6 py-2 whitespace-nowrap cursor-pointer transition">
              Matérias
            </Link>
            <Link to="/artigo" className="text-white hover:text-blue-500 text-xl font-bold px-6 py-2 whitespace-nowrap cursor-pointer transition">
              Artigo
            </Link>
            <Link to="/comofunciona" className="text-white hover:text-blue-500 text-xl font-bold px-6 py-2 whitespace-nowrap cursor-pointer transition">
              Dispositivo
            </Link>
            <Link to="/sobre-nos" className="text-white hover:text-blue-500 text-xl font-bold px-6 py-2 whitespace-nowrap cursor-pointer transition">
              Sobre Nós
            </Link>
          </div>
